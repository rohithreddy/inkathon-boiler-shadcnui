    ...
    return (
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            className="h-12 min-w-[14rem] gap-2 rounded-2xl border border-white/10  px-4 py-3 font-bold text-foreground bg-primary"
  ...
  return (
    <div className="flex select-none flex-wrap items-stretch justify-center gap-4 ">
      ...
      <DropdownMenu>
        <DropdownMenuTrigger
          asChild
          className="rounded-2xl px-4 py-6 font-bold text-foreground"
        >
          <Button className="min-w-[14rem] border bg-primary" translate="no">
        ...
        <div className="flex font-mono text-sm font-bold text-foreground">
          {/* <div className="flex min-w-[10rem] items-center justify-center gap-2 rounded-2xl border-2  px-4 py-3 font-mono text-sm font-bold text-foreground"></div> */}
      ...
      {/* Account Balance
      {reducibleBalanceFormatted !== undefined && (
        <div className="flex min-w-[10rem] items-center justify-center gap-2 rounded-2xl border-2  px-4 py-3 font-mono text-sm font-bold text-foreground">
          {reducibleBalanceFormatted}
          {(!reducibleBalance || reducibleBalance?.isZero()) && (
            <Tooltip>
              <TooltipTrigger className="cursor-help">
